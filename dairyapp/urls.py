...
urlpatterns=[
    ...
    path('due/<id>/delete',views.dueDelete,name='due-delete'),
    path('due/<id>/update',views.dueUpdate,name='due-update'),
    path('sellers/',views.sellers,name='sellers'),
    path('sellers/<id>/delete',views.sellerDelete,name='seller-delete'),
    path('sellers/<id>/update',views.sellerUpdate,name='seller-update'),
    path('buyers/<id>/delete',views.buyerDelete,name='buyer-delete'),
    path('buyers/<id>/update',views.buyerUpdate,name='buyer-update'),
